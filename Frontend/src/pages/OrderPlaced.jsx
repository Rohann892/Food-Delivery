...
const OrderPlaced = () => {
  ...
  return (
    <div className="min-h-screen bg-[#fff9f6] flex flex-col justify-center items-center px-4 text-center relative overflow-hidden">
      <FaCircleCheck className="text-green-500 text-6xl mb-4" size={30} />
      ...
      <button
        className="bg-[#ff4d2d] hover:bg-[#e65426] text-white px-6 py-3 rounded-lg text-lg font-medium transition"
